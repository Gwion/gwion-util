...
%type<flag> flag func_flag type_flag opt_flag
%type<sym>id opt_id
...
func_ptr
  : type_flag type_decl2 LPAREN id RPAREN func_args arg_type
    { $$ = new_stmt_fptr($4, $2, $6, $7); $2->flag |= $1; }
  ;

stmt_type
  : type_flag type_decl2 id SEMICOLON { $$ = new_stmt_type($2, $3); $2->flag |= $1; };
  ;
...
switch_stmt
  : SWITCH LPAREN exp RPAREN code_segment { $$ = new_stmt_switch($3, $5);}
  ;
...
func_def_base
  : func_flag type_decl2 id func_args arg_type code_segment
...
func_def
  ...
  | AST_DTOR LPAREN RPAREN code_segment
    { $$ = new_func_def(new_type_decl(new_id_list(insert_symbol("void"), get_pos(arg)), 0),
       insert_symbol("dtor"), NULL, $4, ae_flag_dtor); }
  ;
